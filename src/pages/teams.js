        ...
        <div className="row">
          <div className="col-md-9 p-2">
            <div className="px-4 py-6">
              <h1 className="text-4xl font-extrabold py-4 text-center text-gray-800">
                Cricket Teams
              </h1>
              <h2 className="text-2xl font-semibold py-2 text-center text-gray-600">
            ...
            <h1 className="text-4xl font-bold py-2 mt-10 text-center">
              Cricket Teams
            </h1>
            <h2 className="text-2xl font-semibold py-2 text-center">ILT20 Teams</h2>
