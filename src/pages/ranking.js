...
const RankingsCard = ({ title, data, imageUrl }) => {
    return (
        <div className="bg-white border rounded-lg shadow-md m-2 flex flex-col h-full">
            ...
            <div className="text-center bg-blue-950 hover:bg-blue-600 border-t p-2 mt-auto">
            ...
            <div className="bg-white-100 min-h-screen">
                <div className="container mx-auto p-8 bg-white rounded-2xl shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {/* Batting Rankings */}
                        <RankingsCard
                            title="Test Batting Rankings"
                            data={data?.batting?.test || []}
                            imageUrl="https://example.com/test-batting-image.jpg"
                        />
                        <RankingsCard
                            title="ODI Batting Rankings"
                            data={data?.batting?.odi || []}
                            imageUrl="https://example.com/odi-batting-image.jpg"
                        />
                        <RankingsCard
                            title="T20I Batting Rankings"
                            data={data?.batting?.t20i || []}
                            imageUrl="https://example.com/t20i-batting-image.jpg"
                        />

                        {/* Bowling Rankings */}
                        
                        <RankingsCard
                            title="Test Bowling Rankings"
                            data={data?.bowling?.test || []}
                            imageUrl="https://example.com/test-bowling-image.jpg"
                        />
                        <RankingsCard
                            title="ODI Bowling Rankings"
                            data={data?.bowling?.odi || []}
                            imageUrl="https://example.com/odi-bowling-image.jpg"
                        />
                        <RankingsCard
                            title="T20I Bowling Rankings"
                            data={data?.bowling?.t20i || []}
                            imageUrl="https://example.com/t20i-bowling-image.jpg"
                        />

                        {/* Allrounder Rankings */}
                        <RankingsCard
                            title="Test Allrounder Rankings"
                            data={data?.allrounder?.test || []}
                            imageUrl="https://example.com/test-allrounder-image.jpg"
                        />
                        <RankingsCard
                            title="ODI Allrounder Rankings"
                            data={data?.allrounder?.odi || []}
                            imageUrl="https://example.com/odi-allrounder-image.jpg"
                        />
                        <RankingsCard
                            title="T20I Allrounder Rankings"
                            data={data?.allrounder?.t20i || []}
                            imageUrl="https://example.com/t20i-allrounder-image.jpg"
                        />

                        {/* Team Rankings */}
                        <RankingsCard
                            title="Test Team Rankings"
                            data={data?.test || []}
                            imageUrl="https://example.com/test-team-image.jpg"
                        />
                        <RankingsCard
                            title="ODI Team Rankings"
                            data={data?.odi || []}
                            imageUrl="https://example.com/odi-team-image.jpg"
                        />
                        <RankingsCard
                            title="T20I Team Rankings"
                            data={data?.t20i || []}
                            imageUrl="https://example.com/t20i-team-image.jpg"
                        />
                    </div>
                </div>
            </div>
